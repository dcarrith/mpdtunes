	...
	<!--<base href="http://www.mpdtunes.com" />-->
		...
		<link rel="stylesheet" href="/includes/css/themes/mpdtunes.css" />

		<link rel="stylesheet" href="/includes/css/themes/jquery.mobile.icons.min.css" />
		<link rel="stylesheet" href="/includes/css/mpdtunes.main.css" />
		<link rel="stylesheet" href="/includes/css/jquery.mobile.custom.structure-1.4.5.css" />
		...
		<script type="text/javascript" src="/includes/js/jquery-2.1.3.js"></script>
		...
		<script type="text/javascript" src="/includes/js/jquery.mobile.custom-1.4.5.js"></script>
		...
		{{-- determine whether to use white or black icon sets --}}

		@if ( $theme_icon_class == "ui-icon-alt" )
		...
		<!-- cat themes/mpdtunes.css themes/jquery.mobile.icons.min.css mpdtunes.main.css jquery.mobile.custom.structure-1.4.5.css jquery.mobile.structure.overrides.css mpdtunes.player.css jquery.plupload.v2.1.1.queue.css > mpdtunes.css -->

		<!-- java -jar yuicompressor-2.4.8.jar mpdtunes.css > mpdtunes.min.css -->

		<script type="text/javascript" src="/includes/js/jqm.cc.min.js"></script>

		<!--java -jar compiler.jar --compilation_level SIMPLE_OPTIMIZATIONS --js=jquery-2.1.3.js --js=jquery-ui-1.10.4.custom.js --js=jquery.easing.1.3.js --js=dust-core-2.3.1.js  --js=jquery.mobile.defaults.overrides.js --js=jquery.mobile.custom-1.4.5.js --js=jquery.mobile.lazyloader.js --js=fastclick.js --js=jquery.ui.touch-punch.js --js=jquery.jplayer.js --js=autobahn.js --create_source_map ./jqm.cc.min.js.map --source_map_format=V3 --js_output_file=jqm.cc.min.js -->
