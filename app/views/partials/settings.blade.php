	...
	<div data-role="popup" data-overlay-theme="{{ $theme_body }}" data-shadow="true" id="{{ $popupMenuId; }}" data-theme="{{ $theme_body }}">
		...
		<ul data-role="listview" data-inset="true" data-theme="{{ $theme_body }}">
			...
			<li data-role="divider" data-theme="{{ $theme_buttons }}" class="ui-li ui-li-static ui-btn-up-a ui-corner-top">{{ $settings_i18n }}</li>

			<li data-icon="delete" data-iconpos="right" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="div" class="ui-btn ui-li" data-theme="{{ $theme_buttons }}">
			...
			<li data-icon="arrow-r" data-iconpos="right" data-inset="true" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="div" data-theme="{{ $theme_buttons }}" class="ui-btn ui-li ui-btn-up-{{ $theme_buttons }}">
					
				{{ HTML::link('#', $volume_crossfade_i18n, array('id'=>'volume_crossfade_button', 'class'=>'ui-link-inherit', 'data-theme'=>$theme_buttons)) }}
			</li>

			<li data-icon="refresh" data-iconpos="right" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="div" data-theme="{{ $theme_buttons }}" class="ui-btn ui-li ui-btn-up-{{ $theme_buttons }}">
			...
			<li data-role="divider" data-theme="{{ $theme_buttons }}" class="ui-li ui-li-static ui-btn-up-a ui-corner-top"></li>
		</ul>
	</div>
