		...
		<div data-role="popup" id="queueTrackPopupMenu" data-overlay-theme="{{ $theme_body }}" data-shadow="true" data-theme="{{ $theme_body }}">
			...
			<ul data-role="listview" data-inset="true" data-theme="{{ $theme_body }}">
				...
				<li data-icon="carat-r" data-iconpos="right" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-theme="{{ $theme_action }}" class="ui-btn ui-btn-icon-right ui-li ui-btn-up-{{ $theme_action }}">
