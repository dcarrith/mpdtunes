...
class mpd {
	...
	function RefreshInfo() {
		...
		$this->playlist_id = $status['playlist'];
		$this->playlist_length = $status['playlistlength'];
		$this->xfade = $status['xfade'];
		$this->song = $status['song'];
		$this->song_id = $status['songid'];
		$this->time = $status['time'];
		$this->bitrate = $status['bitrate'];
		$this->audio_sampling = $status['audio'];
		$this->next_song = $status['nextsong'];
		$this->next_song_id = $status['nextsongid'];
