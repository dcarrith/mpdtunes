					...
					'<div class="plupload">' +
						'<div class="plupload_header">' +
							'<div class="plupload_header_content">' +
								...
								'<div class="plupload_header_text">' + _('Add files to queue and click upload.') + '</div>' +
							'</div>' +
						'</div>' +
							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										'<a href="#" class="plupload_button plupload_add" id="' + id + '_browse">' + _('Add') + '</a>' +
										'<a href="#" class="plupload_button plupload_start">' + _('Upload') + '</a>' +
									'</div>' +
