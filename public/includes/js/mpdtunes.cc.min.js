...
return f});d("moxie/core/utils/Env",["moxie/core/utils/Basic"],function(a){var b=function(a){var b={has:function(a,e){return-1!==e.toLowerCase().indexOf(a.toLowerCase())},lowerize:function(a){return a.toLowerCase()}},f=function(){for(var b,f=0,g,c,l,k,d,m=arguments;f<m.length;f+=2){d=m[f];var n=m[f+1];if("undefined"===typeof b)for(l in b={},n)g=n[l],"object"===typeof g?b[g[0]]=a:b[g]=a;for(g=c=0;g<d.length;g++)if(k=d[g].exec(this.getUA())){for(l=0;l<n.length;l++)d=k[++c],g=n[l],"object"===typeof g&&
0<g.length?2==g.length?b[g[0]]="function"==typeof g[1]?g[1].call(this,d):g[1]:3==g.length?b[g[0]]="function"!==typeof g[1]||g[1].exec&&g[1].test?d?d.replace(g[1],g[2]):a:d?g[1].call(this,d,g[2]):a:4==g.length&&(b[g[0]]=d?g[3].call(this,d.replace(g[1],g[2])):a):b[g]=d?d:a;break}if(k)break}return b},c=function(f,c){for(var l in c)if("object"===typeof c[l]&&0<c[l].length)for(var d=0;d<c[l].length;d++){if(b.has(c[l][d],f))return"?"===l?a:l}else if(b.has(c[l],f))return"?"===l?a:l;return f},k={ME:"4.90",
"NT 3.11":"NT3.51","NT 4.0":"NT4.0",2E3:"NT 5.0",XP:["NT 5.1","NT 5.2"],Vista:"NT 6.0",7:"NT 6.1",8:"NT 6.2","8.1":"NT 6.3",RT:"ARM"},d=[[/(opera\smini)\/((\d+)?[\w\.-]+)/i,/(opera\s[mobiletab]+).+version\/((\d+)?[\w\.-]+)/i,/(opera).+version\/((\d+)?[\w\.]+)/i,/(opera)[\/\s]+((\d+)?[\w\.]+)/i],["name","version","major"],[/\s(opr)\/((\d+)?[\w\.]+)/i],[["name","Opera"],"version","major"],[/(kindle)\/((\d+)?[\w\.]+)/i,/(lunascape|maxthon|netfront|jasmine|blazer)[\/\s]?((\d+)?[\w\.]+)*/i,/(avant\s|iemobile|slim|baidu)(?:browser)?[\/\s]?((\d+)?[\w\.]*)/i,
...
["version","name"]],p=[[/(windows)\snt\s6\.2;\s(arm)/i,/(windows\sphone(?:\sos)*|windows\smobile|windows)[\s\/]?([ntce\d\.\s]+\w)/i],["name",["version",c,k]],[/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],[["name","Windows"],["version",c,k]],[/\((bb)(10);/i],[["name","BlackBerry"],"version"],[/(blackberry)\w*\/?([\w\.]+)*/i,/(tizen)\/([\w\.]+)/i,/(android|webos|palm\os|qnx|bada|rim\stablet\sos|meego)[\/\s-]?([\w\.]+)*/i],["name","version"],[/(symbian\s?os|symbos|s60(?=;))[\/\s-]?([\w\.]+)*/i],[["name",
...
d)};this.getEngine=function(){return f.apply(this,m)};this.getOS=function(){return f.apply(this,p)};this.getResult=function(){return{ua:this.getUA(),browser:this.getBrowser(),engine:this.getEngine(),os:this.getOS()}};this.getUA=function(){return b};this.setUA=function(a){b=a;return this};this.setUA(b)}).getResult()}(),f={can:function(){var b={define_property:!1,create_canvas:function(){var a=document.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))}(),return_response_type:function(b){try{if(-1!==
a.inArray(b,["","text","document"]))return!0;if(window.XMLHttpRequest){var e=new XMLHttpRequest;e.open("get","/");if("responseType"in e)return e.responseType=b,e.responseType!==b?!1:!0}}catch(f){}return!1},use_data_uri:function(){var a=new Image;a.onload=function(){b.use_data_uri=1===a.width&&1===a.height};setTimeout(function(){a.src="data:image/gif;base64,R0lGODlhAQABAIAAAP8AAAAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="},1);return!1}(),use_data_uri_over32kb:function(){return b.use_data_uri&&("IE"!==
f.browser||9<=f.version)},use_data_uri_of:function(a){return b.use_data_uri&&33E3>a||b.use_data_uri_over32kb()},use_fileinput:function(){var a=document.createElement("input");a.setAttribute("type","file");return!a.disabled}};return function(f){var c=[].slice.call(arguments);c.shift();return"function"===a.typeOf(b[f])?b[f].apply(this,c):!!b[f]}}(),browser:b.browser.name,version:parseFloat(b.browser.major),os:b.os.name,osVersion:b.os.version,verComp:function(a,b,f){var c=0,d=0,k=0,m={dev:-6,alpha:-5,
a:-5,beta:-4,b:-4,RC:-3,rc:-3,"#":-2,p:1,pl:1},c=function(a){a=(""+a).replace(/[_\-+]/g,".");a=a.replace(/([^.\d]+)/g,".$1.").replace(/\.{2,}/g,".");return a.length?a.split("."):[-8]},p=function(a){return a?isNaN(a)?m[a]||-7:parseInt(a,10):0};a=c(a);b=c(b);d=Math.max(a.length,b.length);for(c=0;c<d;c++)if(a[c]!=b[c])if(a[c]=p(a[c]),b[c]=p(b[c]),a[c]<b[c]){k=-1;break}else if(a[c]>b[c]){k=1;break}if(!f)return k;switch(f){case ">":case "gt":return 0<k;case ">=":case "ge":return 0<=k;case "<=":case "le":return 0>=
...
a="CSS1Compat"===n.compatMode?n.documentElement:n.body,e=b.left+a.scrollLeft,b=b.top+a.scrollTop);return{x:e,y:b}}var d=0,k=0,r,n=document;e=e||n.body;if(b&&b.getBoundingClientRect&&"IE"===a.browser&&(!n.documentMode||8>n.documentMode))return d=c(b),k=c(e),{x:d.x-k.x,y:d.y-k.y};for(r=b;r&&r!=e&&r.nodeType;)d+=r.offsetLeft||0,k+=r.offsetTop||0,r=r.offsetParent;for(r=b.parentNode;r&&r!=e&&r.nodeType;)d-=r.scrollLeft||0,k-=r.scrollTop||0,r=r.parentNode;return{x:d,y:k}},getSize:function(a){return{w:a.offsetWidth||
...
f){a=a.toLowerCase();var c=e[this.uid]&&e[this.uid][a],d;if(c){if(f)for(d=c.length-1;0<=d;d--){if(c[d].fn===f){c.splice(d,1);break}}else c=[];c.length||(delete e[this.uid][a],b.isEmptyObj(e[this.uid])&&delete e[this.uid])}},removeAllEventListeners:function(){e[this.uid]&&delete e[this.uid]},dispatchEvent:function(c){var f,d,r,n={},s=!0;if("string"!==b.typeOf(c))if(d=c,"string"===b.typeOf(d.type))c=d.type,void 0!==d.total&&void 0!==d.loaded&&(n.total=d.total,n.loaded=d.loaded),n.async=d.async||!1;
else throw new a.EventException(a.EventException.UNSPECIFIED_EVENT_TYPE_ERR);-1!==c.indexOf("::")?function(a){f=a[0];c=a[1]}(c.split("::")):f=this.uid;c=c.toLowerCase();if(d=e[f]&&e[f][c]){d.sort(function(a,b){return b.priority-a.priority});r=[].slice.call(arguments);r.shift();n.type=c;r.unshift(n);var p=[];b.each(d,function(a){r[0].target=a.scope;n.async?p.push(function(b){setTimeout(function(){b(!1===a.fn.apply(a.scope,r))},1)}):p.push(function(b){b(!1===a.fn.apply(a.scope,r))})});p.length&&b.inSeries(p,
function(a){s=!a})}return s},bind:function(){this.addEventListener.apply(this,arguments)},unbind:function(){this.removeEventListener.apply(this,arguments)},unbindAll:function(){this.removeAllEventListeners.apply(this,arguments)},trigger:function(){return this.dispatchEvent.apply(this,arguments)},convertEventPropsToHandlers:function(a){var e;"array"!==b.typeOf(a)&&(a=[a]);for(var c=0;c<a.length;c++)e="on"+a[c],"function"===b.typeOf(this[e])?this.addEventListener(a[c],this[e]):"undefined"===b.typeOf(this[e])&&
(this[e]=null)}})}f.instance=new f;return f});d("moxie/core/utils/Encode",[],function(){var a=function(a){return unescape(encodeURIComponent(a))},b=function(a){return decodeURIComponent(escape(a))};return{utf8_encode:a,utf8_decode:b,atob:function(a,e){if("function"===typeof window.atob)return e?b(window.atob(a)):window.atob(a);var c,d,l,m,n,s=0,p=0;m="";var u=[];if(!a)return a;a+="";do c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(s++)),d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(s++)),
m="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(s++)),n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(s++)),l=c<<18|d<<12|m<<6|n,c=l>>16&255,d=l>>8&255,l&=255,64==m?u[p++]=String.fromCharCode(c):64==n?u[p++]=String.fromCharCode(c,d):u[p++]=String.fromCharCode(c,d,l);while(s<a.length);m=u.join("");return e?b(m):m},btoa:function(b,e){e&&a(b);if("function"===typeof window.btoa)return window.btoa(b);var c,d,k,r,n=0,s=0,p="",
p=[];if(!b)return b;do c=b.charCodeAt(n++),d=b.charCodeAt(n++),k=b.charCodeAt(n++),r=c<<16|d<<8|k,c=r>>18&63,d=r>>12&63,k=r>>6&63,r&=63,p[s++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(r);while(n<b.length);p=p.join("");n=b.length%3;return(n?
p.slice(0,n-3):p)+"===".slice(n||3)}}});d("moxie/runtime/Runtime",["moxie/core/utils/Basic","moxie/core/utils/Dom","moxie/core/EventTarget"],function(a,b,c){function e(c,d,f,g,p){var u=this,v,t=a.guid(d+"_");p=p||"browser";c=c||{};q[t]=this;f=a.extend({access_binary:!1,access_image_binary:!1,display_media:!1,do_cors:!1,drag_and_drop:!1,filter_by_extension:!0,resize_image:!1,report_upload_progress:!1,return_response_headers:!1,return_response_type:!1,return_status_code:!0,send_custom_headers:!1,select_file:!1,
select_folder:!1,select_multiple:!0,send_binary_string:!1,send_browser_cookies:!0,send_multipart:!0,slice_blob:!1,stream_upload:!1,summon_file_dialog:!1,upload_filesize:!0,use_http_method:!0},f);c.preferred_caps&&(p=e.getMode(g,c.preferred_caps,p));v=function(){var b={};return{exec:function(a,e,c,d){if(v[e]&&(b[a]||(b[a]={context:this,instance:new v[e]}),b[a].instance[c]))return b[a].instance[c].apply(this,d)},removeInstance:function(a){delete b[a]},removeAllInstances:function(){var e=this;a.each(b,
function(b,c){"function"===a.typeOf(b.instance.destroy)&&b.instance.destroy.call(b.context);e.removeInstance(c)})}}}();a.extend(this,{initialized:!1,uid:t,type:d,mode:e.getMode(g,c.required_caps,p),shimid:t+"_container",clients:0,options:c,can:function(b,c,d){d=d||f;"string"===a.typeOf(b)&&"undefined"===a.typeOf(c)&&(b=e.parseCaps(b));if("object"===a.typeOf(b)){for(var k in b)if(!this.can(k,b[k],d))return!1;return!0}return"function"===a.typeOf(d[b])?d[b].call(this,c):c===d[b]},getShimContainer:function(){var e,
...
2);return u[a]&&u[a][b]?u[a][b].apply(this,e):u.shimExec.apply(this,arguments)},destroy:function(){if(u){var a=b.get(this.shimid);a&&a.parentNode.removeChild(a);v&&v.removeAllInstances();this.unbindAll();delete q[this.uid];t=u=v=this.uid=null}}});this.mode&&c.required_caps&&!this.can(c.required_caps)&&(this.mode=!1)}var d={},q={};e.order="html5,flash,silverlight,html4";e.getRuntime=function(a){return q[a]?q[a]:!1};e.addConstructor=function(a,b){b.prototype=c.instance;d[a]=b};e.getConstructor=function(a){return d[a]||
null};e.getInfo=function(a){var b=e.getRuntime(a);return b?{uid:b.uid,type:b.type,mode:b.mode,can:function(){return b.can.apply(b,arguments)}}:null};e.parseCaps=function(b){var e={};if("string"!==a.typeOf(b))return b||{};a.each(b.split(","),function(a){e[a]=!0});return e};e.can=function(a,b){var c;c=e.getConstructor(a);var d;return c?(c=new c({required_caps:b}),d=c.mode,c.destroy(),!!d):!1};e.thatCan=function(a,b){var c=(b||e.order).split(/\s*,\s*/),d;for(d in c)if(e.can(c[d],a))return c[d];return null};
e.getMode=function(b,e,c){var d=null;"undefined"===a.typeOf(c)&&(c="browser");if(e&&!a.isEmptyObj(b)){a.each(e,function(e,c){if(b.hasOwnProperty(c)){var f=b[c](e);"string"===typeof f&&(f=[f]);if(!d)d=f;else if(!(d=a.arrayIntersect(d,f)))return d=!1}});if(d)return-1!==a.inArray(c,d)?c:d[0];if(!1===d)return!1}return c};e.capTrue=function(){return!0};e.capFalse=function(){return!1};e.capTest=function(a){return function(){return!!a}};return e});d("moxie/runtime/RuntimeClient",["moxie/core/Exceptions",
"moxie/core/utils/Basic","moxie/runtime/Runtime"],function(a,b,c){return function(){var e;b.extend(this,{connectRuntime:function(d){function q(b){var k;b.length?(k=b.shift(),(k=c.getConstructor(k))?(e=new k(d),e.bind("Init",function(){e.initialized=!0;setTimeout(function(){e.clients++;l.trigger("RuntimeInit",e)},1)}),e.bind("Error",function(){e.destroy();q(b)}),e.mode?e.init():e.trigger("Error")):q(b)):(l.trigger("RuntimeError",new a.RuntimeError(a.RuntimeError.NOT_INIT_ERR)),e=null)}var l=this,r;
"string"===b.typeOf(d)?r=d:"string"===b.typeOf(d.ruid)&&(r=d.ruid);if(r){if(e=c.getRuntime(r))return e.clients++,e;throw new a.RuntimeError(a.RuntimeError.NOT_INIT_ERR);}q((d.runtime_order||c.order).split(/\s*,\s*/))},getRuntime:function(){return e&&e.uid?e:e=null},disconnectRuntime:function(){e&&0>=--e.clients&&(e.destroy(),e=null)}})}});d("moxie/file/Blob",["moxie/core/utils/Basic","moxie/core/utils/Encode","moxie/runtime/RuntimeClient"],function(a,b,c){function e(q,l){function r(b,c,f){var k=d[this.uid];
if("string"!==a.typeOf(k)||!k.length)return null;c=new e(null,{type:f,size:c-b});c.detach(k.substr(b,c.size));return c}c.call(this);q&&this.connectRuntime(q);l?"string"===a.typeOf(l)&&(l={data:l}):l={};a.extend(this,{uid:l.uid||a.guid("uid_"),ruid:q,size:l.size||0,type:l.type||"",slice:function(a,b,c){return this.isDetached()?r.apply(this,arguments):this.getRuntime().exec.call(this,"Blob","slice",this.getSource(),a,b,c)},getSource:function(){return d[this.uid]?d[this.uid]:null},detach:function(a){this.ruid&&
(this.getRuntime().exec.call(this,"Blob","destroy",d[this.uid]),this.disconnectRuntime(),this.ruid=null);a=a||"";var c=a.match(/^data:([^;]*);base64,/);c&&(this.type=c[1],a=b.atob(a.substring(a.indexOf("base64,")+7)));this.size=a.length;d[this.uid]=a},isDetached:function(){return!this.ruid&&"string"===a.typeOf(d[this.uid])},destroy:function(){this.detach();delete d[this.uid]}});l.data?this.detach(l.data):d[this.uid]=l}var d={};return e});d("moxie/file/File",["moxie/core/utils/Basic","moxie/core/utils/Mime",
...
function(a,b,c,e,d,q,l,r,n){function s(d){var g=this,s;-1!==a.inArray(a.typeOf(d),["string","node"])&&(d={browse_button:d});s=c.get(d.browse_button);if(!s)throw new e.DOMException(e.DOMException.NOT_FOUND_ERR);s={accept:[{title:q.translate("All Files"),extensions:"*"}],name:"file",multiple:!1,required_caps:!1,container:s.parentNode||document.body};d=a.extend({},s,d);"string"===typeof d.required_caps&&(d.required_caps=r.parseCaps(d.required_caps));"string"===typeof d.accept&&(d.accept=b.mimes2extList(d.accept));
s=c.get(d.container);s||(s=document.body);"static"===c.getStyle(s,"position")&&(s.style.position="relative");s=s=null;n.call(g);a.extend(g,{uid:a.guid("uid_"),ruid:null,shimid:null,files:null,init:function(){g.convertEventPropsToHandlers(p);g.bind("RuntimeInit",function(b,e){g.ruid=e.uid;g.shimid=e.shimid;g.bind("Ready",function(){g.trigger("Refresh")},999);g.bind("Change",function(){var b=e.exec.call(g,"FileInput","getFiles");g.files=[];a.each(b,function(a){if(0===a.size)return!0;g.files.push(new l(g.ruid,
a))})},999);g.bind("Refresh",function(){var b,k,g;k=c.get(d.browse_button);g=c.get(e.shimid);k&&(b=c.getPos(k,c.get(d.container)),k=c.getSize(k),g&&a.extend(g.style,{top:b.y+"px",left:b.x+"px",width:k.w+"px",height:k.h+"px"}))});e.exec.call(g,"FileInput","init",d)});g.connectRuntime(a.extend({},d,{required_caps:{select_file:!0}}))},disable:function(b){var c=this.getRuntime();c&&c.exec.call(this,"FileInput","disable","undefined"===a.typeOf(b)?!0:b)},refresh:function(){g.trigger("Refresh")},destroy:function(){var b=
this.getRuntime();b&&(b.exec.call(this,"FileInput","destroy"),this.disconnectRuntime());"array"===a.typeOf(this.files)&&a.each(this.files,function(a){a.destroy()});this.files=null}})}var p="ready change cancel mouseenter mouseleave mousedown mouseup".split(" ");s.prototype=d.instance;return s});d("moxie/file/FileDrop","moxie/core/I18n moxie/core/utils/Dom moxie/core/Exceptions moxie/core/utils/Basic moxie/file/File moxie/runtime/RuntimeClient moxie/core/EventTarget moxie/core/utils/Mime".split(" "),
function(a,b,c,e,d,q,l,r){function n(c){var f=this,l;"string"===typeof c&&(c={drop_zone:c});l={accept:[{title:a.translate("All Files"),extensions:"*"}],required_caps:{drag_and_drop:!0}};c="object"===typeof c?e.extend({},l,c):l;c.container=b.get(c.drop_zone)||document.body;"static"===b.getStyle(c.container,"position")&&(c.container.style.position="relative");"string"===typeof c.accept&&(c.accept=r.mimes2extList(c.accept));q.call(f);e.extend(f,{uid:e.guid("uid_"),ruid:null,files:null,init:function(){f.convertEventPropsToHandlers(s);
f.bind("RuntimeInit",function(a,b){f.ruid=b.uid;f.bind("Drop",function(){var a=b.exec.call(f,"FileDrop","getFiles");f.files=[];e.each(a,function(a){f.files.push(new d(f.ruid,a))})},999);b.exec.call(f,"FileDrop","init",c);f.dispatchEvent("ready")});f.connectRuntime(c)},destroy:function(){var a=this.getRuntime();a&&(a.exec.call(this,"FileDrop","destroy"),this.disconnectRuntime());this.files=null}})}var s=["ready","dragenter","dragleave","drop","error"];n.prototype=l.instance;return n});d("moxie/runtime/RuntimeTarget",
["moxie/core/utils/Basic","moxie/runtime/RuntimeClient","moxie/core/EventTarget"],function(a,b,c){function e(){this.uid=a.guid("uid_");b.call(this);this.destroy=function(){this.disconnectRuntime();this.unbindAll()}}e.prototype=c.instance;return e});d("moxie/file/FileReader","moxie/core/utils/Basic moxie/core/utils/Encode moxie/core/Exceptions moxie/core/EventTarget moxie/file/Blob moxie/file/File moxie/runtime/RuntimeTarget".split(" "),function(a,b,c,e,d,q,l){function r(){function e(a,m){function s(a){p.readyState=
r.DONE;p.error=a;p.trigger("error");h()}function h(){q.destroy();q=null;p.trigger("loadend")}function w(b){q.bind("Error",function(a,b){s(b)});q.bind("Progress",function(a){p.result=b.exec.call(q,"FileReader","getResult");p.trigger(a)});q.bind("Load",function(a){p.readyState=r.DONE;p.result=b.exec.call(q,"FileReader","getResult");p.trigger(a);h()});b.exec.call(q,"FileReader","read",a,m)}q=new l;this.convertEventPropsToHandlers(n);if(this.readyState===r.LOADING)return s(new c.DOMException(c.DOMException.INVALID_STATE_ERR));
this.readyState=r.LOADING;this.trigger("loadstart");if(m instanceof d)if(m.isDetached()){var x=m.getSource();switch(a){case "readAsText":case "readAsBinaryString":this.result=x;break;case "readAsDataURL":this.result="data:"+m.type+";base64,"+b.btoa(x)}this.readyState=r.DONE;this.trigger("load");h()}else w(q.connectRuntime(m.ruid));else s(new c.DOMException(c.DOMException.NOT_FOUND_ERR))}var p=this,q;a.extend(this,{uid:a.guid("uid_"),readyState:r.EMPTY,result:null,error:null,readAsBinaryString:function(a){e.call(this,
"readAsBinaryString",a)},readAsDataURL:function(a){e.call(this,"readAsDataURL",a)},readAsText:function(a){e.call(this,"readAsText",a)},abort:function(){this.result=null;-1===a.inArray(this.readyState,[r.EMPTY,r.DONE])&&(this.readyState===r.LOADING&&(this.readyState=r.DONE),q&&q.getRuntime().exec.call(this,"FileReader","abort"),this.trigger("abort"),this.trigger("loadend"))},destroy:function(){this.abort();q&&(q.getRuntime().exec.call(this,"FileReader","destroy"),q.disconnectRuntime());p=q=null}})}
var n="loadstart progress load abort error loadend".split(" ");r.EMPTY=0;r.LOADING=1;r.DONE=2;r.prototype=e.instance;return r});d("moxie/core/utils/Url",[],function(){var a=function(b,c){for(var e="source scheme authority userInfo user pass host port relative path directory file query fragment".split(" "),d=e.length,q={http:80,https:443},l={},r=/^(?:([^:\/?#]+):)?(?:\/\/()(?:(?:()(?:([^:@]*):?([^:@]*))?@)?([^:\/?#]*)(?::(\d*))?))?()(?:(()(?:(?:[^?#\/]*\/)*)()(?:[^?#]*))(?:\\?([^#]*))?(?:#(.*))?)/.exec(b||
"");d--;)r[d]&&(l[e[d]]=r[d]);l.scheme||(c&&"string"!==typeof c||(c=a(c||document.location.href)),l.scheme=c.scheme,l.host=c.host,l.port=c.port,e="",/^[^\/]/.test(l.path)&&(e=c.path,e=/(\/|\/[^\.]+)$/.test(e)?e+"/":e.replace(/\/[^\/]+$/,"/")),l.path=e+(l.path||""));l.port||(l.port=q[l.scheme]||80);l.port=parseInt(l.port,10);l.path||(l.path="/");delete l.source;return l};return{parseUrl:a,resolveUrl:function(b){b=a(b);return b.scheme+"://"+b.host+(b.port!=={http:80,https:443}[b.scheme]?":"+b.port:
...
withCredentials:g.withCredentials,options:I},b)}var g=this;(new Date).getTime();G=new l;"string"===typeof I.required_caps&&(I.required_caps=q.parseCaps(I.required_caps));I.required_caps=a.extend({},I.required_caps,{return_response_type:g.responseType});b instanceof s&&(I.required_caps.send_multipart=!0);T||(I.required_caps.do_cors=!0);I.ruid?d(G.connectRuntime(I)):(G.bind("RuntimeInit",function(a,b){d(b)}),G.bind("RuntimeError",function(a,b){g.dispatchEvent("RuntimeError",b)}),G.connectRuntime(I))}
var n=this,C={timeout:0,readyState:h.UNSENT,withCredentials:!1,status:0,statusText:"",responseType:"",responseXML:null,responseText:null,response:null},H=!0,y,E,K={},J,O,P=null,F=null,L=!1,D=!1,M=!1,N=!1,S=!1,T=!1,I={},G,R="",Q;a.extend(this,C,{uid:a.guid("uid_"),upload:new v,open:function(f,l,n,p,q){if(!f||!l)throw new b.DOMException(b.DOMException.SYNTAX_ERR);if(/[\u0100-\uffff]/.test(f)||e.utf8_encode(f)!==f)throw new b.DOMException(b.DOMException.SYNTAX_ERR);~a.inArray(f.toUpperCase(),"CONNECT DELETE GET HEAD OPTIONS POST PUT TRACE TRACK".split(" "))&&
(E=f.toUpperCase());if(~a.inArray(E,["CONNECT","TRACE","TRACK"]))throw new b.DOMException(b.DOMException.SECURITY_ERR);l=e.utf8_encode(l);f=d.parseUrl(l);T=d.hasSameOrigin(f);y=d.resolveUrl(l);if((p||q)&&!T)throw new b.DOMException(b.DOMException.INVALID_ACCESS_ERR);J=p||f.user;O=q||f.pass;H=n||!0;if(!1===H&&(c("timeout")||c("withCredentials")||""!==c("responseType")))throw new b.DOMException(b.DOMException.INVALID_ACCESS_ERR);L=!H;D=!1;K={};c("responseText","");c("responseXML",null);c("response",
...
/^(proxy\-|sec\-)/.test(d))return!1;K[d]=K[d]?K[d]+(", "+f):f;return!0},getAllResponseHeaders:function(){return R||""},getResponseHeader:function(b){b=b.toLowerCase();return S||~a.inArray(b,["set-cookie","set-cookie2"])?null:R&&""!==R&&(Q||(Q={},a.each(R.split(/\r\n/),function(b){b=b.split(/:\s+/);2===b.length&&(b[0]=a.trim(b[0]),Q[b[0].toLowerCase()]={header:b[0],value:a.trim(b[1])})})),Q.hasOwnProperty(b))?Q[b].header+": "+Q[b].value:null},overrideMimeType:function(d){var e;if(~a.inArray(c("readyState"),
[h.LOADING,h.DONE]))throw new b.DOMException(b.DOMException.INVALID_STATE_ERR);d=a.trim(d.toLowerCase());/;/.test(d)&&(e=d.match(/^([^;]+)(?:;\scharset\=)?(.*)$/))&&(d=e[1]);if(!u.mimes[d])throw new b.DOMException(b.DOMException.SYNTAX_ERR);},send:function(c,d){I="string"===a.typeOf(d)?{ruid:d}:d?d:{};this.convertEventPropsToHandlers(A);this.upload.convertEventPropsToHandlers(A);if(this.readyState!==h.OPENED||D)throw new b.DOMException(b.DOMException.INVALID_STATE_ERR);if(c instanceof r)I.ruid=c.ruid,
...
h.UNSENT=0;h.OPENED=1;h.HEADERS_RECEIVED=2;h.LOADING=3;h.DONE=4;h.prototype=c.instance;return h});d("moxie/runtime/Transporter",["moxie/core/utils/Basic","moxie/core/utils/Encode","moxie/runtime/RuntimeClient","moxie/core/EventTarget"],function(a,b,c,d){function g(){function d(b,c){var f=this;n=c;f.bind("TransportingProgress",function(b){h=b.loaded;h<p&&-1===a.inArray(f.state,[g.IDLE,g.DONE])&&e.call(f)},999);f.bind("TransportingComplete",function(){h=p;f.state=g.DONE;s=null;f.result=n.exec.call(f,
"Transporter","getAsBlob",b||"")},999);f.state=g.BUSY;f.trigger("TransportingStarted");e.call(f)}function e(){var a;a=p-h;v>a&&(v=a);a=b.btoa(s.substr(h,v));n.exec.call(this,"Transporter","receive",a,p)}var r,n,s,p,h,v;c.call(this);a.extend(this,{uid:a.guid("uid_"),state:g.IDLE,result:null,transport:function(b,c,e){var f=this;e=a.extend({chunk_size:204798},e);if(r=e.chunk_size%3)e.chunk_size+=3-r;v=e.chunk_size;p=h=0;s=this.result=null;s=b;p=b.length;if("string"===a.typeOf(e)||e.ruid)d.call(f,c,this.connectRuntime(e));
else{var g=function(a,b){f.unbind("RuntimeInit",g);d.call(f,c,b)};this.bind("RuntimeInit",g);this.connectRuntime(e)}},abort:function(){this.state=g.IDLE;n&&(n.exec.call(this,"Transporter","clear"),this.trigger("TransportingAborted"));p=h=0;s=this.result=null},destroy:function(){this.unbindAll();n=null;this.disconnectRuntime();p=h=0;s=this.result=null}})}g.IDLE=0;g.BUSY=1;g.DONE=2;g.prototype=d.instance;return g});d("moxie/image/Image","moxie/core/utils/Basic moxie/core/utils/Dom moxie/core/Exceptions moxie/file/FileReaderSync moxie/xhr/XMLHttpRequest moxie/runtime/Runtime moxie/runtime/RuntimeClient moxie/runtime/Transporter moxie/core/utils/Env moxie/core/EventTarget moxie/file/Blob moxie/file/File moxie/core/utils/Encode".split(" "),
function(a,b,c,d,g,q,l,r,n,s,p,h,v){function t(){function d(b){var g=a.typeOf(b);try{if(b instanceof t){if(!b.size)throw new c.DOMException(c.DOMException.INVALID_STATE_ERR);e.apply(this,arguments)}else if(b instanceof p){if(!~a.inArray(b.type,["image/jpeg","image/png"]))throw new c.ImageError(c.ImageError.WRONG_FORMAT);s.apply(this,arguments)}else if(-1!==a.inArray(g,["blob","file"]))d.call(this,new h(null,b),arguments[1]);else if("string"===g)/^data:[^;]*;base64,/.test(b)?d.call(this,new p(null,
{data:b}),arguments[1]):B.apply(this,arguments);else if("node"===g&&"img"===b.nodeName.toLowerCase())d.call(this,b.src,arguments[1]);else throw new c.DOMException(c.DOMException.TYPE_MISMATCH_ERR);}catch(k){this.trigger("error",k)}}function e(b,c){var d=this.connectRuntime(b.ruid);this.ruid=d.uid;d.exec.call(this,"Image","loadFromImage",b,"undefined"===a.typeOf(c)?!0:c)}function s(b,c){function d(a){e.ruid=a.uid;a.exec.call(e,"Image","loadFromBlob",b)}var e=this;e.name=b.name||"";b.isDetached()?(this.bind("RuntimeInit",
function(a,b){d(b)}),c&&"string"===typeof c.required_caps&&(c.required_caps=q.parseCaps(c.required_caps)),this.connectRuntime(a.extend({required_caps:{access_image_binary:!0,resize_image:!0}},c))):d(this.connectRuntime(b.ruid))}function B(a,b){var c=this,d;d=new g;d.open("get",a);d.responseType="blob";d.onprogress=function(a){c.trigger(a)};d.onload=function(){s.call(c,d.response,!0)};d.onerror=function(a){c.trigger(a)};d.onloadend=function(){d.destroy()};d.bind("RuntimeError",function(a,b){c.trigger("RuntimeError",
b)});d.send(null,b)}l.call(this);a.extend(this,{uid:a.guid("uid_"),ruid:null,name:"",size:0,width:0,height:0,type:"",meta:{},clone:function(){this.load.apply(this,arguments)},load:function(){this.bind("Load Resize",function(){var a=void 0,a=this.getRuntime().exec.call(this,"Image","getInfo");this.size=a.size;this.width=a.width;this.height=a.height;this.type=a.type;this.meta=a.meta;""===this.name&&(this.name=a.name)},999);this.convertEventPropsToHandlers(z);d.apply(this,arguments)},downsize:function(b,
d,e,g){try{if(!this.size)throw new c.DOMException(c.DOMException.INVALID_STATE_ERR);if(this.width>t.MAX_RESIZE_WIDTH||this.height>t.MAX_RESIZE_HEIGHT)throw new c.ImageError(c.ImageError.MAX_RESOLUTION_ERR);if(!b&&!d||"undefined"===a.typeOf(e))e=!1;b=b||this.width;d=d||this.height;g="undefined"===a.typeOf(g)?!0:!!g;this.getRuntime().exec.call(this,"Image","downsize",b,d,e,g)}catch(k){this.trigger("error",k)}},crop:function(a,b,c){this.downsize(a,b,!0,c)},getAsCanvas:function(){if(!n.can("create_canvas"))throw new c.RuntimeError(c.RuntimeError.NOT_SUPPORTED_ERR);
...
b);return v.atob(c.substring(c.indexOf("base64,")+7))},embed:function(d,e){function g(){if(n.can("create_canvas")){var b=p.getAsCanvas();if(b){d.appendChild(b);b=null;p.destroy();l.trigger("embedded");return}}b=p.getAsDataURL(q,s);if(!b)throw new c.ImageError(c.ImageError.WRONG_FORMAT);if(n.can("use_data_uri_of",b.length))d.innerHTML='<img src="'+b+'" width="'+p.width+'" height="'+p.height+'" />',p.destroy(),l.trigger("embedded");else{var e=new r;e.bind("TransportingComplete",function(){M=l.connectRuntime(this.result.ruid);
l.bind("Embedded",function(){a.extend(M.getShimContainer().style,{top:"0px",left:"0px",width:p.width+"px",height:p.height+"px"});M=null},999);M.exec.call(l,"ImageView","display",this.result.uid,A,w);p.destroy()});e.transport(v.atob(b.substring(b.indexOf("base64,")+7)),q,a.extend({},u,{required_caps:{display_media:!0},runtime_order:"flash,silverlight",container:d}))}}var l=this,p,q,s,h,u=e||{},A=this.width,w=this.height,M;try{if(!(d=b.get(d)))throw new c.DOMException(c.DOMException.INVALID_NODE_TYPE_ERR);
if(!this.size)throw new c.DOMException(c.DOMException.INVALID_STATE_ERR);if(this.width>t.MAX_RESIZE_WIDTH||this.height>t.MAX_RESIZE_HEIGHT)throw new c.ImageError(c.ImageError.MAX_RESOLUTION_ERR);q=u.type||this.type||"image/jpeg";s=u.quality||90;h="undefined"!==a.typeOf(u.crop)?u.crop:!1;if(u.width)A=u.width,w=u.height||A;else{var N=b.getSize(d);N.w&&N.h&&(A=N.w,w=N.h)}p=new t;p.bind("Resize",function(){g.call(l)});p.bind("Load",function(){p.downsize(A,w,h,!1)});p.clone(this,!1);return p}catch(z){this.trigger("error",
z)}},destroy:function(){this.ruid&&(this.getRuntime().exec.call(this,"Image","destroy"),this.disconnectRuntime());this.unbindAll()}})}var z=["progress","load","error","resize","embedded"];t.MAX_RESIZE_WIDTH=6500;t.MAX_RESIZE_HEIGHT=6500;t.prototype=s.instance;return t});d("moxie/runtime/html5/Runtime",["moxie/core/utils/Basic","moxie/core/Exceptions","moxie/runtime/Runtime","moxie/core/utils/Env"],function(a,b,c,d){var g={};c.addConstructor("html5",function(b,k,r){var n=this,s=c.capTest,p=c.capTrue;
r=a.extend({access_binary:s(window.FileReader||window.File&&window.File.getAsDataURL),access_image_binary:function(){return n.can("access_binary")&&!!g.Image},display_media:s(d.can("create_canvas")||d.can("use_data_uri_over32kb")),do_cors:s(window.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest),drag_and_drop:s(function(){var a=document.createElement("div");return("draggable"in a||"ondragstart"in a&&"ondrop"in a)&&("IE"!==d.browser||9<d.version)}()),filter_by_extension:s("Chrome"===d.browser&&
28<=d.version||"IE"===d.browser&&10<=d.version),return_response_headers:p,return_response_type:function(a){return"json"===a&&window.JSON?!0:d.can("return_response_type",a)},return_status_code:p,report_upload_progress:s(window.XMLHttpRequest&&(new XMLHttpRequest).upload),resize_image:function(){return n.can("access_binary")&&d.can("create_canvas")},select_file:function(){return d.can("use_fileinput")&&window.File},select_folder:function(){return n.can("select_file")&&"Chrome"===d.browser&&21<=d.version},
select_multiple:function(){return n.can("select_file")&&!("Safari"===d.browser&&"Windows"===d.os)&&!("iOS"===d.os&&d.verComp(d.osVersion,"7.0.4","<"))},send_binary_string:s(window.XMLHttpRequest&&((new XMLHttpRequest).sendAsBinary||window.Uint8Array&&window.ArrayBuffer)),send_custom_headers:s(window.XMLHttpRequest),send_multipart:function(){return!!(window.XMLHttpRequest&&(new XMLHttpRequest).upload&&window.FormData)||n.can("send_binary_string")},slice_blob:s(window.File&&(File.prototype.mozSlice||
File.prototype.webkitSlice||File.prototype.slice)),stream_upload:function(){return n.can("slice_blob")&&n.can("send_multipart")},summon_file_dialog:s("Firefox"===d.browser&&4<=d.version||"Opera"===d.browser&&12<=d.version||"IE"===d.browser&&10<=d.version||!!~a.inArray(d.browser,["Chrome","Safari"])),upload_filesize:p},r);c.call(this,b,k||"html5",r);a.extend(this,{init:function(){this.trigger("Init")},destroy:function(a){return function(){a.call(n);a=n=null}}(this.destroy)});a.extend(this.getShim(),
g)});return g});d("moxie/runtime/html5/file/Blob",["moxie/runtime/html5/Runtime","moxie/file/Blob"],function(a,b){return a.Blob=function(){function a(b,c,d){var f;if(window.File.prototype.slice)try{return b.slice(),b.slice(c,d)}catch(k){return b.slice(c,d-c)}else return(f=window.File.prototype.webkitSlice||window.File.prototype.mozSlice)?f.call(b,c,d):null}this.slice=function(){return new b(this.getRuntime().uid,a.apply(this,arguments))}}});d("moxie/core/utils/Events",["moxie/core/utils/Basic"],function(a){function b(){this.returnValue=
!1}function c(){this.cancelBubble=!0}var d={},g="moxie_"+a.guid(),q=function(b,c,f){var k;c=c.toLowerCase();if(b[g]&&d[b[g]]&&d[b[g]][c]){k=d[b[g]][c];for(var p=k.length-1;0<=p;p--)if(k[p].orig===f||k[p].key===f)if(b.removeEventListener?b.removeEventListener(c,k[p].func,!1):b.detachEvent&&b.detachEvent("on"+c,k[p].func),k[p].orig=null,k[p].func=null,k.splice(p,1),void 0!==f)break;k.length||delete d[b[g]][c];if(a.isEmptyObj(d[b[g]])){delete d[b[g]];try{delete b[g]}catch(q){b[g]=void 0}}}};return{addEvent:function(l,
q,n,s){var p;q=q.toLowerCase();l.addEventListener?(p=n,l.addEventListener(q,p,!1)):l.attachEvent&&(p=function(){var a=window.event;a.target||(a.target=a.srcElement);a.preventDefault=b;a.stopPropagation=c;n(a)},l.attachEvent("on"+q,p));l[g]||(l[g]=a.guid());d.hasOwnProperty(l[g])||(d[l[g]]={});l=d[l[g]];l.hasOwnProperty(q)||(l[q]=[]);l[q].push({func:p,orig:n,key:s})},removeEvent:q,removeAllEvents:function(b,c){b&&b[g]&&a.each(d[b[g]],function(a,d){q(b,d,c)})}}});d("moxie/runtime/html5/file/FileInput",
"moxie/runtime/html5/Runtime moxie/core/utils/Basic moxie/core/utils/Dom moxie/core/utils/Events moxie/core/utils/Mime moxie/core/utils/Env".split(" "),function(a,b,c,d,g,q){return a.FileInput=function(){var a=[],m;b.extend(this,{init:function(n){var s=this,p=s.getRuntime(),h,v,t;m=n;a=[];n=m.accept.mimes||g.extList2mimes(m.accept,p.can("filter_by_extension"));h=p.getShimContainer();h.innerHTML='<input id="'+p.uid+'" type="file" style="font-size:999px;opacity:0;"'+(m.multiple&&p.can("select_multiple")?
"multiple":"")+(m.directory&&p.can("select_folder")?"webkitdirectory directory":"")+(n?' accept="'+n.join(",")+'"':"")+" />";n=c.get(p.uid);b.extend(n.style,{position:"absolute",top:0,left:0,width:"100%",height:"100%"});v=c.get(m.browse_button);p.can("summon_file_dialog")&&("static"===c.getStyle(v,"position")&&(v.style.position="relative"),t=parseInt(c.getStyle(v,"z-index"),10)||1,v.style.zIndex=t,h.style.zIndex=t-1,d.addEvent(v,"click",function(a){var b=c.get(p.uid);b&&!b.disabled&&b.click();a.preventDefault()},
s.uid));h=p.can("summon_file_dialog")?v:h;d.addEvent(h,"mouseover",function(){s.trigger("mouseenter")},s.uid);d.addEvent(h,"mouseout",function(){s.trigger("mouseleave")},s.uid);d.addEvent(h,"mousedown",function(){s.trigger("mousedown")},s.uid);d.addEvent(c.get(m.container),"mouseup",function(){s.trigger("mouseup")},s.uid);n.onchange=function A(){a=[];m.directory?b.each(this.files,function(b){"."!==b.name&&a.push(b)}):a=[].slice.call(this.files);if("IE"!==q.browser)this.value="";else{var c=this.cloneNode(!0);
...
u.push(a)):d.push(b))});d.length?n(d,c):c()}function n(a,c){var d=[];b.each(a,function(a){d.push(function(b){h(a,b)})});b.inSeries(d,function(){c()})}function h(a,b){a.isFile?a.file(function(a){l(a)&&u.push(a);b()},function(){b()}):a.isDirectory?p(a,b):b()}function p(a,b){function c(a){e.readEntries(function(b){b.length?([].push.apply(d,b),c(a)):a()},a)}var d=[],e=a.createReader();c(function(){n(d,b)})}var u=[],v=[],t;b.extend(this,{init:function(c){var f=this;t=c;v=a(t.accept);c=t.container;d.addEvent(c,
...
"moxie/runtime/html5/Runtime moxie/core/utils/Basic moxie/core/utils/Mime moxie/core/utils/Url moxie/file/File moxie/file/Blob moxie/xhr/FormData moxie/core/Exceptions moxie/core/utils/Env".split(" "),function(a,b,c,d,g,q,l,h,n){return a.XMLHttpRequest=function(){function a(b,c){var d=this,e,f;e=c.getBlob().getSource();f=new window.FileReader;f.onload=function(){c.append(c.getBlobName(),new q(null,{type:e.type,data:f.result}));v.send.call(d,b,c)};f.readAsBinaryString(e)}function m(){if(!window.XMLHttpRequest||
"IE"===n.browser&&8>n.version){var a;a:{for(var b=["Msxml2.XMLHTTP.6.0","Microsoft.XMLHTTP"],c=0;c<b.length;c++)try{a=new ActiveXObject(b[c]);break a}catch(d){}a=void 0}return a}return new window.XMLHttpRequest}function u(a){var b="----moxieboundary"+(new Date).getTime(),c="";if(!this.getRuntime().can("send_binary_string"))throw new h.RuntimeError(h.RuntimeError.NOT_SUPPORTED_ERR);t.setRequestHeader("Content-Type","multipart/form-data; boundary="+b);a.each(function(a,d){c=a instanceof q?c+("--"+b+
'\r\nContent-Disposition: form-data; name="'+d+'"; filename="'+unescape(encodeURIComponent(a.name||"blob"))+'"\r\nContent-Type: '+(a.type||"application/octet-stream")+"\r\n\r\n"+a.getSource()+"\r\n"):c+("--"+b+'\r\nContent-Disposition: form-data; name="'+d+'"\r\n\r\n'+unescape(encodeURIComponent(a))+"\r\n")});return c+="--"+b+"--\r\n"}var v=this,t,z;b.extend(this,{send:function(c,f){var g=this,h="Mozilla"===n.browser&&4<=n.version&&7>n.version,r="Android Browser"===n.browser,v=!1;z=c.url.replace(/^.+?\/([\w\-\.]+)$/,
"$1").toLowerCase();t=m();t.open(c.method,c.url,c.async,c.user,c.password);if(f instanceof q)f.isDetached()&&(v=!0),f=f.getSource();else if(f instanceof l){if(f.hasBlob())if(f.getBlob().isDetached())f=u.call(g,f),v=!0;else if((h||r)&&"blob"===b.typeOf(f.getBlob().getSource())&&window.FileReader){a.call(g,c,f);return}if(f instanceof l){var y=new window.FormData;f.each(function(a,b){a instanceof q?y.append(b,a.getSource()):y.append(b,a)});f=y}}t.upload?(c.withCredentials&&(t.withCredentials=!0),t.addEventListener("load",
...
total:parseInt(a,10),loaded:b});break;case 4:t.onreadystatechange=function(){},0===t.status?g.trigger("error"):g.trigger("load")}};b.isEmptyObj(c.headers)||b.each(c.headers,function(a,b){t.setRequestHeader(b,a)});""!==c.responseType&&"responseType"in t&&("json"!==c.responseType||n.can("return_response_type","json")?t.responseType=c.responseType:t.responseType="text");v?t.sendAsBinary?t.sendAsBinary(f):function(){for(var a=new Uint8Array(f.length),b=0;b<f.length;b++)a[b]=f.charCodeAt(b)&255;t.send(a.buffer)}():
t.send(f);g.trigger("loadstart")},getStatus:function(){try{if(t)return t.status}catch(a){}return 0},getResponse:function(a){var b=this.getRuntime();try{switch(a){case "blob":var d=new g(b.uid,t.response),e=t.getResponseHeader("Content-Disposition");if(e){var k=e.match(/filename=([\'\"'])([^\1]+)\1/);k&&(z=k[2])}d.name=z;d.type||(d.type=c.getFileMime(z));return d;case "json":return n.can("return_response_type","json")?t.response:200===t.status&&window.JSON?JSON.parse(t.responseText):null;case "document":var l;
var m=t.responseXML,p=t.responseText;"IE"===n.browser&&p&&m&&!m.documentElement&&/[^\/]+\/[^\+]+\+xml/.test(t.getResponseHeader("Content-Type"))&&(m=new window.ActiveXObject("Microsoft.XMLDOM"),m.async=!1,m.validateOnParse=!1,m.loadXML(p));l=m&&("IE"===n.browser&&0!==m.parseError||!m.documentElement||"parsererror"===m.documentElement.tagName)?null:m;return l;default:return""!==t.responseText?t.responseText:null}}catch(q){return null}},getAllResponseHeaders:function(){try{return t.getAllResponseHeaders()}catch(a){}return""},
abort:function(){t&&t.abort()},destroy:function(){v=z=null}})}});d("moxie/runtime/html5/utils/BinaryReader",[],function(){return function(){function b(a,c){var k=d?0:-8*(c-1),m=0,n;for(n=0;n<c;n++)m|=e.charCodeAt(a+n)<<Math.abs(k+8*n);return m}function c(a,b,d){d=3===arguments.length?d:e.length-b-1;e=e.substr(0,b)+a+e.substr(d+b)}var d=!1,e;return{II:function(b){if(b===a)return d;d=b},init:function(a){d=!1;e=a},SEGMENT:function(a,b,d){switch(arguments.length){case 1:return e.substr(a,e.length-a-1);
case 2:return e.substr(a,b);case 3:c(d,a,b);break;default:return e}},BYTE:function(a){return b(a,1)},SHORT:function(a){return b(a,2)},LONG:function(e,q){if(q===a)return b(e,4);var l="",h=d?0:-24,n;for(n=0;4>n;n++)l+=String.fromCharCode(q>>Math.abs(h+8*n)&255);c(l,e,4)},SLONG:function(a){a=b(a,4);return 2147483647<a?a-4294967296:a},STRING:function(a,c){var d="";for(c+=a;a<c;a++)d+=String.fromCharCode(b(a,1));return d}}}});d("moxie/runtime/html5/image/JPEGHeaders",["moxie/runtime/html5/utils/BinaryReader"],
function(a){return function f(b){var c=[],d,l,h,n=0;d=new a;d.init(b);if(65496===d.SHORT(0)){for(l=2;l<=b.length;)if(h=d.SHORT(l),65488<=h&&65495>=h)l+=2;else{if(65498===h||65497===h)break;n=d.SHORT(l+2)+2;65505<=h&&65519>=h&&c.push({hex:h,name:"APP"+(h&15),start:l,length:n,segment:d.SEGMENT(l,n)});l+=n}d.init(null);return{headers:c,restore:function(a){var b;d.init(a);l=65504==d.SHORT(2)?4+d.SHORT(4):2;b=0;for(a=c.length;b<a;b++)d.SEGMENT(l,0,c[b].segment),l+=c[b].length;a=d.SEGMENT();d.init(null);
return a},strip:function(a){var b,c;c=new f(a);b=c.headers;c.purge();d.init(a);for(a=b.length;a--;)d.SEGMENT(b[a].start,b[a].length,"");a=d.SEGMENT();d.init(null);return a},get:function(a){for(var b=[],d=0,e=c.length;d<e;d++)c[d].name===a.toUpperCase()&&b.push(c[d].segment);return b},set:function(a,b){var d=[],e,f,m;"string"===typeof b?d.push(b):d=b;e=f=0;for(m=c.length;e<m&&!(c[e].name===a.toUpperCase()&&(c[e].segment=d[f],c[e].length=d[f].length,f++),f>=d.length);e++);},purge:function(){c=[];d.init(null);
d=null}}}}});d("moxie/runtime/html5/image/ExifParser",["moxie/core/utils/Basic","moxie/runtime/html5/utils/BinaryReader"],function(b,c){return function(){function d(b,c){var f=e.SHORT(b),g,k,m,h,q,w=[],x={};for(g=0;g<f;g++)if(q=b+12*g+2,m=c[e.SHORT(q)],m!==a){k=e.SHORT(q+=2);h=e.LONG(q+=2);q+=4;w=[];switch(k){case 1:case 7:4<h&&(q=e.LONG(q)+l.tiffHeader);for(k=0;k<h;k++)w[k]=e.BYTE(q+k);break;case 2:4<h&&(q=e.LONG(q)+l.tiffHeader);x[m]=e.STRING(q,h-1);continue;case 3:2<h&&(q=e.LONG(q)+l.tiffHeader);
for(k=0;k<h;k++)w[k]=e.SHORT(q+2*k);break;case 4:1<h&&(q=e.LONG(q)+l.tiffHeader);for(k=0;k<h;k++)w[k]=e.LONG(q+4*k);break;case 5:q=e.LONG(q)+l.tiffHeader;for(k=0;k<h;k++)w[k]=e.LONG(q+4*k)/e.LONG(q+4*k+4);break;case 9:q=e.LONG(q)+l.tiffHeader;for(k=0;k<h;k++)w[k]=e.SLONG(q+4*k);break;case 10:q=e.LONG(q)+l.tiffHeader;for(k=0;k<h;k++)w[k]=e.SLONG(q+4*k)/e.SLONG(q+4*k+4);break;default:continue}h=1==h?w[0]:w;r.hasOwnProperty(m)&&"object"!=typeof h?x[m]=r[m][h]:x[m]=h}return x}var e,g,h,l={},r;e=new c;
...
["moxie/core/utils/Basic","moxie/core/Exceptions","moxie/runtime/html5/image/JPEGHeaders","moxie/runtime/html5/utils/BinaryReader","moxie/runtime/html5/image/ExifParser"],function(a,b,c,d,g){return function(h){var l,r,n,s,p,u;l=h;r=new d;r.init(l);if(65496!==r.SHORT(0))throw new b.ImageError(b.ImageError.WRONG_FORMAT);n=new c(h);s=new g;u=!!s.init(n.get("app1")[0]);p=function(){for(var a=0,b;a<=l.length;){b=r.SHORT(a+=2);if(65472<=b&&65475>=b)return a+=5,{height:r.SHORT(a),width:r.SHORT(a+2)};b=r.SHORT(a+=
2);a+=b-2}return null}.call(this);a.extend(this,{type:"image/jpeg",size:l.length,width:p&&p.width||0,height:p&&p.height||0,setExif:function(b,c){if(!u)return!1;"object"===a.typeOf(b)?a.each(b,function(a,b){s.setExif(b,a)}):s.setExif(b,c);n.set("app1",s.getBinary())},writeHeaders:function(){return arguments.length?n.restore(arguments[0]):l=n.restore(l)},stripHeaders:function(a){return n.strip(a)},purge:function(){s&&n&&r&&(s.purge(),n.purge(),r.init(null),l=p=n=s=r=null)}});u&&(this.meta={tiff:s.TIFF(),
...
renderTo:function(b,c,d){var g=b.naturalWidth,h=b.naturalHeight,l=d.width,r=d.height,n=d.x||0;d=d.y||0;c=c.getContext("2d");a(b)&&(g/=2,h/=2);var s=document.createElement("canvas");s.width=s.height=1024;var p=s.getContext("2d"),u;u=h;var v=document.createElement("canvas");v.width=1;v.height=u;v=v.getContext("2d");v.drawImage(b,0,0);for(var v=v.getImageData(0,0,1,u).data,t=0,z=u,A=u;A>t;)0===v[4*(A-1)+3]?z=A:t=A,A=z+t>>1;u=A/u;u=0===u?1:u;for(v=0;v<h;){t=v+1024>h?h-v:1024;for(z=0;z<g;){A=z+1024>g?
g-z:1024;p.clearRect(0,0,1024,1024);p.drawImage(b,-z,-v);var w=z*l/g+n<<0,x=Math.ceil(A*l/g),B=v*r/h/u+d<<0,C=Math.ceil(t*r/h/u);c.drawImage(s,0,0,A,t,w,B,x,C);z+=1024}v+=1024}}}});d("moxie/runtime/html5/image/Image","moxie/runtime/html5/Runtime moxie/core/utils/Basic moxie/core/Exceptions moxie/core/utils/Encode moxie/file/File moxie/runtime/html5/image/ImageInfo moxie/runtime/html5/image/MegaPixel moxie/core/utils/Mime moxie/core/utils/Env".split(" "),function(a,b,c,d,g,h,l,r,n){return a.Image=
...
e.onerror=function(){d.trigger("error",new c.FileException(c.FileException.NOT_READABLE_ERR))},e.readAsDataURL(a);else return b(a.getAsDataURL())}function t(c,d,e,f){var g,m=0,h=0,p,q;E=f;q=this.meta&&this.meta.tiff&&this.meta.tiff.Orientation||1;-1!==b.inArray(q,[5,6,7,8])&&(p=c,c=d,d=p);p=a();g=(e?Math.max:Math.min)(c/p.width,d/p.height);if(!(1<g)||e&&!f){B||(B=document.createElement("canvas"));f=Math.round(p.width*g);g=Math.round(p.height*g);e?(B.width=c,B.height=d,f>c&&(m=Math.round((f-c)/2)),
g>d&&(h=Math.round((g-d)/2))):(B.width=f,B.height=g);if(!E){c=B.width;d=B.height;switch(q){case 5:case 6:case 7:case 8:B.width=d;B.height=c;break;default:B.width=c,B.height=d}e=B.getContext("2d");switch(q){case 2:e.translate(c,0);e.scale(-1,1);break;case 3:e.translate(c,d);e.rotate(Math.PI);break;case 4:e.translate(0,d);e.scale(1,-1);break;case 5:e.rotate(.5*Math.PI);e.scale(1,-1);break;case 6:e.rotate(.5*Math.PI);e.translate(0,-d);break;case 7:e.rotate(.5*Math.PI);e.translate(c,-d);e.scale(-1,1);
break;case 8:e.rotate(-.5*Math.PI),e.translate(-c,0)}}q=B;m=-m;h=-h;"iOS"===n.OS?l.renderTo(p,q,{width:f,height:g,x:m,y:h}):q.getContext("2d").drawImage(p,m,h,f,g);this.width=B.width;this.height=B.height;y=!0}this.trigger("Resize")}function z(){x&&(x.purge(),x=null);C=w=B=H=null;y=!1}var A=this,w,x,B,C,H,y=!1,E=!0;b.extend(this,{loadFromBlob:function(a){var b=this,d=b.getRuntime(),e=1<arguments.length?arguments[1]:!0;if(!d.can("access_binary"))throw new c.RuntimeError(c.RuntimeError.NOT_SUPPORTED_ERR);
...
"moxie/core/utils/Env","moxie/core/utils/Dom","moxie/core/Exceptions","moxie/runtime/Runtime"],function(a,b,c,d,g){function h(){var a;try{a=navigator.plugins["Shockwave Flash"],a=a.description}catch(b){try{a=(new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version")}catch(c){a="0.0"}}a=a.match(/\d+/g);return parseFloat(a[0]+"."+a[1])}var l={};g.addConstructor("flash",function(r){var n=this,s;r=a.extend({swf_url:b.swf_url},r);g.call(this,r,"flash",{access_binary:function(a){return a&&
"browser"===n.mode},access_image_binary:function(a){return a&&"browser"===n.mode},display_media:g.capTrue,do_cors:g.capTrue,drag_and_drop:!1,report_upload_progress:function(){return"client"===n.mode},resize_image:g.capTrue,return_response_headers:!1,return_response_type:function(b){return"json"===b&&window.JSON?!0:!a.arrayDiff(b,["","text","document"])||"browser"===n.mode},return_status_code:function(b){return"browser"===n.mode||!a.arrayDiff(b,[200,404])},select_file:g.capTrue,select_multiple:g.capTrue,
send_binary_string:function(a){return a&&"browser"===n.mode},send_browser_cookies:function(a){return a&&"browser"===n.mode},send_custom_headers:function(a){return a&&"browser"===n.mode},send_multipart:g.capTrue,slice_blob:g.capTrue,stream_upload:function(a){return a&&"browser"===n.mode},summon_file_dialog:!1,upload_filesize:function(b){return 2097152>=a.parseSizeStr(b)||"client"===n.mode},use_http_method:function(b){return!a.arrayDiff(b,["GET","POST"])}},{access_binary:function(a){return a?"browser":
...
"browser":"client"},stream_upload:function(a){return a?"client":"browser"},upload_filesize:function(b){return 2097152<=a.parseSizeStr(b)?"client":"browser"}},"client");10>h()&&(this.mode=!1);a.extend(this,{getShim:function(){return c.get(this.uid)},shimExec:function(a,b){var c=[].slice.call(arguments,2);return n.getShim().exec(this.uid,a,b,c)},init:function(){var c,f,g;g=this.getShimContainer();a.extend(g.style,{position:"absolute",top:"-8px",left:"-8px",width:"9px",height:"9px",overflow:"hidden"});
...
g.appendChild(f),f.outerHTML=c,f=g=null):g.innerHTML=c;s=setTimeout(function(){n&&!n.initialized&&n.trigger("Error",new d.RuntimeError(d.RuntimeError.NOT_INIT_ERR))},5E3)},destroy:function(a){return function(){a.call(n);clearTimeout(s);r=s=a=n=null}}(this.destroy)},l)});return l});d("moxie/runtime/flash/file/Blob",["moxie/runtime/flash/Runtime","moxie/file/Blob"],function(a,b){return a.Blob={slice:function(a,c,d,h){var l=this.getRuntime();0>c?c=Math.max(a.size+c,0):0<c&&(c=Math.min(c,a.size));0>d?
...
"moxie/core/Exceptions","moxie/runtime/Runtime"],function(a,b,c,d,g){function h(a){var b=!1,c=null,d,e,f,g,k,l=0;try{try{c=new ActiveXObject("AgControl.AgControl"),c.IsVersionSupported(a)&&(b=!0)}catch(m){var q=navigator.plugins["Silverlight Plug-In"];if(q){d=q.description;"1.0.30226.2"===d&&(d="2.0.30226.2");for(e=d.split(".");3<e.length;)e.pop();for(;4>e.length;)e.push(0);for(f=a.split(".");4<f.length;)f.pop();do g=parseInt(f[l],10),k=parseInt(e[l],10),l++;while(l<f.length&&g===k);g<=k&&!isNaN(g)&&
(b=!0)}}}catch(B){b=!1}return b}var l={};g.addConstructor("silverlight",function(r){var n=this,s;r=a.extend({xap_url:b.xap_url},r);g.call(this,r,"silverlight",{access_binary:g.capTrue,access_image_binary:g.capTrue,display_media:g.capTrue,do_cors:g.capTrue,drag_and_drop:!1,report_upload_progress:g.capTrue,resize_image:g.capTrue,return_response_headers:function(a){return a&&"client"===n.mode},return_response_type:function(a){return"json"!==a?!0:!!window.JSON},return_status_code:function(b){return"client"===
n.mode||!a.arrayDiff(b,[200,404])},select_file:g.capTrue,select_multiple:g.capTrue,send_binary_string:g.capTrue,send_browser_cookies:function(a){return a&&"browser"===n.mode},send_custom_headers:function(a){return a&&"client"===n.mode},send_multipart:g.capTrue,slice_blob:g.capTrue,stream_upload:!0,summon_file_dialog:!1,upload_filesize:g.capTrue,use_http_method:function(b){return"client"===n.mode||!a.arrayDiff(b,["GET","POST"])}},{return_response_headers:function(a){return a?"client":"browser"},return_status_code:function(b){return a.arrayDiff(b,
[200,404])?"client":["client","browser"]},send_browser_cookies:function(a){return a?"browser":"client"},send_custom_headers:function(a){return a?"client":"browser"},use_http_method:function(b){return a.arrayDiff(b,["GET","POST"])?"client":["client","browser"]}});h("2.0.31005.0")&&"Opera"!==b.browser||(this.mode=!1);a.extend(this,{getShim:function(){return c.get(this.uid).content.Moxie},shimExec:function(a,b){var c=[].slice.call(arguments,2);return n.getShim().exec(this.uid,a,b,c)},init:function(){this.getShimContainer().innerHTML=
'<object id="'+this.uid+'" data="data:application/x-silverlight," type="application/x-silverlight-2" width="100%" height="100%" style="outline:none;"><param name="source" value="'+r.xap_url+'"/><param name="background" value="Transparent"/><param name="windowless" value="true"/><param name="enablehtmlaccess" value="true"/><param name="initParams" value="uid='+this.uid+",target="+b.global_event_dispatcher+'"/></object>';s=setTimeout(function(){n&&!n.initialized&&n.trigger("Error",new d.RuntimeError(d.RuntimeError.NOT_INIT_ERR))},
"Windows"!==b.OS?1E4:5E3)},destroy:function(a){return function(){a.call(n);clearTimeout(s);r=s=a=n=null}}(this.destroy)},l)});return l});d("moxie/runtime/silverlight/file/Blob",["moxie/runtime/silverlight/Runtime","moxie/core/utils/Basic","moxie/runtime/flash/file/Blob"],function(a,b,c){return a.Blob=b.extend({},c)});d("moxie/runtime/silverlight/file/FileInput",["moxie/runtime/silverlight/Runtime"],function(a){return a.FileInput={init:function(a){this.getRuntime().shimExec.call(this,"FileInput","init",
...
function(a,b,c){return a.Transporter=b.extend({},c)});d("moxie/runtime/silverlight/image/Image",["moxie/runtime/silverlight/Runtime","moxie/core/utils/Basic","moxie/runtime/flash/image/Image"],function(a,b,c){return a.Image=b.extend({},c,{getInfo:function(){var a=["tiff","exif","gps"],c={meta:{}},d=this.getRuntime().shimExec.call(this,"Image","getInfo");d.meta&&b.each(a,function(a){var b=d.meta[a],e,f,k,h;if(b&&b.keys)for(c.meta[a]={},f=0,k=b.keys.length;f<k;f++)if(e=b.keys[f],h=b[e])/^(\d|[1-9]\d+)$/.test(h)?
h=parseInt(h,10):/^\d*\.\d+$/.test(h)&&(h=parseFloat(h)),c.meta[a][e]=h});c.width=parseInt(d.width,10);c.height=parseInt(d.height,10);c.size=parseInt(d.size,10);c.type=d.type;c.name=d.name;return c}})});d("moxie/runtime/html4/Runtime",["moxie/core/utils/Basic","moxie/core/Exceptions","moxie/runtime/Runtime","moxie/core/utils/Env"],function(a,b,c,d){var g={};c.addConstructor("html4",function(b){var k=this,h=c.capTest,n=c.capTrue;c.call(this,b,"html4",{access_binary:h(window.FileReader||window.File&&
File.getAsDataURL),access_image_binary:!1,display_media:h(g.Image&&(d.can("create_canvas")||d.can("use_data_uri_over32kb"))),do_cors:!1,drag_and_drop:!1,filter_by_extension:h("Chrome"===d.browser&&28<=d.version||"IE"===d.browser&&10<=d.version),resize_image:function(){return g.Image&&k.can("access_binary")&&d.can("create_canvas")},report_upload_progress:!1,return_response_headers:!1,return_response_type:function(b){return"json"===b&&window.JSON?!0:!!~a.inArray(b,["text","document",""])},return_status_code:function(b){return!a.arrayDiff(b,
[200,404])},select_file:function(){return d.can("use_fileinput")},select_multiple:!1,send_binary_string:!1,send_custom_headers:!1,send_multipart:!0,slice_blob:!1,stream_upload:function(){return k.can("select_file")},summon_file_dialog:h("Firefox"===d.browser&&4<=d.version||"Opera"===d.browser&&12<=d.version||!!~a.inArray(d.browser,["Chrome","Safari"])),upload_filesize:n,use_http_method:function(b){return!a.arrayDiff(b,["GET","POST"])}});a.extend(this,{init:function(){this.trigger("Init")},destroy:function(a){return function(){a.call(k);
a=k=null}}(this.destroy)});a.extend(this.getShim(),g)});return g});d("moxie/runtime/html4/file/FileInput","moxie/runtime/html4/Runtime moxie/core/utils/Basic moxie/core/utils/Dom moxie/core/utils/Events moxie/core/utils/Mime moxie/core/utils/Env".split(" "),function(a,b,c,d,g,h){return a.FileInput=function(){function a(){var g=this,v=g.getRuntime(),t,z,A,w,x;x=b.guid("uid_");t=v.getShimContainer();m&&(z=c.get(m+"_form"))&&b.extend(z.style,{top:"100%"});A=document.createElement("form");A.setAttribute("id",
x+"_form");A.setAttribute("method","post");A.setAttribute("enctype","multipart/form-data");A.setAttribute("encoding","multipart/form-data");b.extend(A.style,{overflow:"hidden",position:"absolute",top:0,left:0,width:"100%",height:"100%"});w=document.createElement("input");w.setAttribute("id",x);w.setAttribute("type","file");w.setAttribute("name",p.name||"Filedata");w.setAttribute("accept",s.join(","));b.extend(w.style,{fontSize:"999px",opacity:0});A.appendChild(w);t.appendChild(A);b.extend(w.style,
{position:"absolute",top:0,left:0,width:"100%",height:"100%"});"IE"===h.browser&&10>h.version&&b.extend(w.style,{filter:"progid:DXImageTransform.Microsoft.Alpha(opacity=0)"});w.onchange=function(){var b;this.value&&(b=this.files?this.files[0]:{name:this.value},n=[b],this.onchange=function(){},a.call(g),g.bind("change",function H(){var a=c.get(x),b=c.get(x+"_form"),d;g.unbind("change",H);g.files.length&&a&&b&&(d=g.files[0],a.setAttribute("id",d.uid),b.setAttribute("id",d.uid+"_form"),b.setAttribute("target",
d.uid+"_iframe"))},998),w=A=null,g.trigger("change"))};v.can("summon_file_dialog")&&(v=c.get(p.browse_button),d.removeEvent(v,"click",g.uid),d.addEvent(v,"click",function(a){w&&!w.disabled&&w.click();a.preventDefault()},g.uid));m=x;t=z=v=null}var m,n=[],s=[],p;b.extend(this,{init:function(b){var k=this,h=k.getRuntime(),m;p=b;s=b.accept.mimes||g.extList2mimes(b.accept,h.can("filter_by_extension"));m=h.getShimContainer();(function(){var a,g;a=c.get(b.browse_button);h.can("summon_file_dialog")&&("static"===
c.getStyle(a,"position")&&(a.style.position="relative"),g=parseInt(c.getStyle(a,"z-index"),10)||1,a.style.zIndex=g,m.style.zIndex=g-1);a=h.can("summon_file_dialog")?a:m;d.addEvent(a,"mouseover",function(){k.trigger("mouseenter")},k.uid);d.addEvent(a,"mouseout",function(){k.trigger("mouseleave")},k.uid);d.addEvent(a,"mousedown",function(){k.trigger("mousedown")},k.uid);d.addEvent(c.get(b.container),"mouseup",function(){k.trigger("mouseup")},k.uid);a=null})();a.call(this);m=null;k.trigger({type:"ready",
async:!0})},getFiles:function(){return n},disable:function(a){var b;if(b=c.get(m))b.disabled=!!a},destroy:function(){var a=this.getRuntime(),b=a.getShim(),a=a.getShimContainer();d.removeAllEvents(a,this.uid);d.removeAllEvents(p&&c.get(p.container),this.uid);d.removeAllEvents(p&&c.get(p.browse_button),this.uid);a&&(a.innerHTML="");b.removeInstance(this.uid);m=n=s=p=null}})}});d("moxie/runtime/html4/file/FileReader",["moxie/runtime/html4/Runtime","moxie/runtime/html5/file/FileReader"],function(a,b){return a.FileReader=
b});d("moxie/runtime/html4/xhr/XMLHttpRequest","moxie/runtime/html4/Runtime moxie/core/utils/Basic moxie/core/utils/Dom moxie/core/utils/Url moxie/core/Exceptions moxie/core/utils/Events moxie/file/Blob moxie/xhr/FormData".split(" "),function(a,b,c,d,g,h,l,r){return a.XMLHttpRequest=function(){function a(b){var d=this,e,g,k,l=!1;if(u){e=u.id.replace(/_iframe$/,"");if(e=c.get(e+"_form")){g=e.getElementsByTagName("input");for(k=g.length;k--;)switch(g[k].getAttribute("type")){case "hidden":g[k].parentNode.removeChild(g[k]);
break;case "file":l=!0}g=[];l||e.parentNode.removeChild(e);e=null}setTimeout(function(){h.removeEvent(u,"load",d.uid);u.parentNode&&u.parentNode.removeChild(u);var a=d.getRuntime().getShimContainer();a.children.length||a.parentNode.removeChild(a);u=null;b()},1)}}var m,p,u;b.extend(this,{send:function(v,t){var z=this,A=z.getRuntime(),w,x,B,C;m=p=null;if(t instanceof r&&t.hasBlob()){if(C=t.getBlob(),w=C.uid,B=c.get(w),x=c.get(w+"_form"),!x)throw new g.DOMException(g.DOMException.NOT_FOUND_ERR);}else w=
...
b=0,c;if(this.state==k.STARTED){for(c=0;c<E.length;c++)a||E[c].status!=k.QUEUED?b++:(a=E[c],this.trigger("BeforeUpload",a)&&(a.status=k.UPLOADING,this.trigger("UploadFile",a)));b==E.length&&(this.state!==k.STOPPED&&(this.state=k.STOPPED,this.trigger("StateChanged")),this.trigger("UploadComplete",E))}}function g(a){a.percent=0<a.size?Math.ceil(a.loaded/a.size*100):100;q()}function q(){var a,b;F.reset();for(a=0;a<E.length;a++)b=E[a],b.size!==c?(F.size+=b.origSize,F.loaded+=b.loaded*b.origSize/b.size):
F.size=c,b.status==k.DONE?F.uploaded++:b.status==k.FAILED?F.failed++:F.queued++;F.size===c?F.percent=0<E.length?Math.ceil(F.uploaded/E.length*100):0:(F.bytesPerSec=Math.ceil(F.loaded/((+new Date-P||1)/1E3)),F.percent=0<F.size?Math.ceil(F.loaded/F.size*100):0)}function l(){var a=J[0]||O[0];return a?a.getRuntime().uid:!1}function r(b,c){if(b.ruid){var d=a.Runtime.getInfo(b.ruid);if(d)return d.can(c)}return!1}function n(b,c){var d=this,e=0,f=[],g={accept:b.filters.mime_types,runtime_order:b.runtimes,
...
b;c||(h=!0);break;default:y[a]=b}c||g.trigger("OptionChanged",a,b,d)}var g=this,h=!1;"object"===typeof b?k.each(b,function(a,b){f(b,a,e)}):f(b,c,e);e?(y.required_features=d(k.extend({},y)),K=d(k.extend({},y,{required_features:!0}))):h&&(g.trigger("Destroy"),n.call(g,y,function(b){b?(g.runtime=a.Runtime.getInfo(l()).type,g.trigger("Init",{runtime:g.runtime}),g.trigger("PostInit")):g.trigger("Error",{code:k.INIT_ERROR,message:k.translate("Init error.")})}))}function u(a,b){[].push.apply(E,b);a.trigger("QueueChanged");
a.refresh()}function v(a,b){if(y.unique_names){var c=b.name.match(/\.([^.]+)$/),d="part";c&&(d=c[1]);b.target_name=b.id+"."+d}}function t(b,c){function d(){0<l--?h(e,1E3):(c.loaded=n,b.trigger("Error",{code:k.HTTP_ERROR,message:k.translate("HTTP Error."),file:c,response:D.responseText,status:D.status,responseHeaders:D.getAllResponseHeaders()}))}function e(){var q,r,s,t;c.status!=k.DONE&&c.status!=k.FAILED&&b.state!=k.STOPPED&&(s={name:c.target_name||c.name},g&&m.chunks&&p.size>g?(t=Math.min(g,p.size-
n),q=p.slice(n,n+t)):(t=p.size,q=p),g&&m.chunks&&(b.settings.send_chunk_number?(s.chunk=Math.ceil(n/g),s.chunks=Math.ceil(p.size/g)):(s.offset=n,s.total=p.size)),D=new a.XMLHttpRequest,D.upload&&(D.upload.onprogress=function(a){c.loaded=Math.min(c.size,n+a.loaded);b.trigger("UploadProgress",c)}),D.onload=function(){400<=D.status?d():(l=b.settings.max_retries,t<p.size?(q.destroy(),n+=t,c.loaded=Math.min(n,p.size),b.trigger("ChunkUploaded",c,{offset:c.loaded,total:p.size,response:D.responseText,status:D.status,
responseHeaders:D.getAllResponseHeaders()}),"Android Browser"===a.Env.browser&&b.trigger("UploadProgress",c)):c.loaded=c.size,q=r=null,!n||n>=p.size?(c.size!=c.origSize&&(p.destroy(),p=null),b.trigger("UploadProgress",c),c.status=k.DONE,b.trigger("FileUploaded",c,{response:D.responseText,status:D.status,responseHeaders:D.getAllResponseHeaders()})):h(e,1))},D.onerror=function(){d()},D.onloadend=function(){this.destroy();D=null},b.settings.multipart&&m.multipart?(s.name=c.target_name||c.name,D.open("post",
f,!0),k.each(b.settings.headers,function(a,b){D.setRequestHeader(b,a)}),r=new a.FormData,k.each(k.extend(s,b.settings.multipart_params),function(a,b){r.append(b,a)}),r.append(b.settings.file_data_name,q),D.send(r,{runtime_order:b.settings.runtimes,required_caps:b.settings.required_features,preferred_caps:K,swf_url:b.settings.flash_swf_url,xap_url:b.settings.silverlight_xap_url})):(f=k.buildUrl(b.settings.url,k.extend(s,b.settings.multipart_params)),D.open("post",f,!0),D.setRequestHeader("Content-Type",
"application/octet-stream"),k.each(b.settings.headers,function(a,b){D.setRequestHeader(b,a)}),D.send(q,{runtime_order:b.settings.runtimes,required_caps:b.settings.required_features,preferred_caps:K,swf_url:b.settings.flash_swf_url,xap_url:b.settings.silverlight_xap_url})))}var f=b.settings.url,g=b.settings.chunk_size,l=b.settings.max_retries,m=b.features,n=0,p;c.loaded&&(n=c.loaded=g*Math.floor(c.loaded/g));p=c.getSource();b.settings.resize.enabled&&r(p,"send_binary_string")&&~a.inArray(p.type,["image/jpeg",
"image/png"])?s.call(this,p,b.settings.resize,function(a){p=a;c.size=a.size;e()}):e()}function z(a,b){g(b)}function A(a){if(a.state==k.STARTED)P=+new Date;else if(a.state==k.STOPPED)for(var b=a.files.length-1;0<=b;b--)a.files[b].status==k.UPLOADING&&(a.files[b].status=k.QUEUED,q())}function w(){D&&D.abort()}function x(a){q();h(function(){e.call(a)},1)}function B(a,b){b.file&&(b.file.status=k.FAILED,g(b.file),a.state==k.STARTED&&(a.trigger("CancelUpload"),h(function(){e.call(a)},1)))}function C(a){a.stop();
...
send_chunk_number:!0};p.call(this,b,null,!0);F=new k.QueueProgress;k.extend(this,{id:H,uid:H,state:k.STOPPED,features:{},runtime:null,files:E,settings:y,total:F,init:function(){var b=this;"function"==typeof y.preinit?y.preinit(b):k.each(y.preinit,function(a,c){b.bind(c,a)});y.browse_button&&y.url?(this.bind("FilesAdded",u),this.bind("CancelUpload",w),this.bind("BeforeUpload",v),this.bind("UploadFile",t),this.bind("UploadProgress",z),this.bind("StateChanged",A),this.bind("QueueChanged",q),this.bind("Error",
B),this.bind("FileUploaded",x),this.bind("Destroy",C),n.call(this,y,function(c){"function"==typeof y.init?y.init(b):k.each(y.init,function(a,c){b.bind(c,a)});c?(b.runtime=a.Runtime.getInfo(l()).type,b.trigger("Init",{runtime:b.runtime}),b.trigger("PostInit")):b.trigger("Error",{code:k.INIT_ERROR,message:k.translate("Init error.")})})):this.trigger("Error",{code:k.INIT_ERROR,message:k.translate("Init error.")})},setOption:function(a,b){p.call(this,a,b,!this.runtime)},getOption:function(a){return a?
...
a)return E[b]},addFile:function(b,c){function d(b,c){var e=[];a.each(f.settings.filters,function(a,c){m[c]&&e.push(function(d){m[c].call(f,a,b,function(a){d(!a)})})});a.inSeries(e,c)}function e(b){var l=a.typeOf(b);if(b instanceof a.File){if(!b.ruid&&!b.isDetached()){if(!p)return!1;b.ruid=p;b.connectRuntime(p)}e(new k.File(b))}else b instanceof a.Blob?(e(b.getSource()),b.destroy()):b instanceof k.File?(c&&(b.name=c),g.push(function(a){d(b,function(c){c||(n.push(b),f.trigger("FileFiltered",b));h(a,
1)})})):-1!==a.inArray(l,["file","blob"])?e(new a.File(null,b)):"node"===l&&"filelist"===a.typeOf(b.files)?a.each(b.files,e):"array"===l&&(c=null,a.each(b,e))}var f=this,g=[],n=[],p;p=l();e(b);g.length&&a.inSeries(g,function(){n.length&&f.trigger("FilesAdded",n)})},removeFile:function(a){a="string"===typeof a?a:a.id;for(var b=E.length-1;0<=b;b--)if(E[b].id===a)return this.splice(b,1)[0]},splice:function(a,b){var d=E.splice(a===c?0:a,b===c?E.length:b),e=!1;this.state==k.STARTED&&(e=!0,this.stop());
...
a.split("-"))&&1<a.length&&parseInt(a[1],10))&&a+1},_chunkedUpload:function(a,c){a.uploadedBytes=a.uploadedBytes||0;var d=this,h=a.files[0],m=h.size,k=a.uploadedBytes,f=a.maxChunkSize||m,e=this._blobSlice,g=b.Deferred(),q=g.promise(),l,r;if(!(this._isXHRUpload(a)&&e&&(k||f<m))||a.data)return!1;if(c)return!0;if(k>=m)return h.error=a.i18n("uploadedBytes"),this._getXHRPromise(!1,a.context,[null,"error",h.error]);r=function(){var c=b.extend({},a),q=c._progress.loaded;c.blob=e.call(h,k,k+f,h.type);c.chunkSize=
c.blob.size;c.contentRange="bytes "+k+"-"+(k+c.chunkSize-1)+"/"+m;d._initXHRData(c);d._initProgressListener(c);l=(!1!==d._trigger("chunksend",null,c)&&b.ajax(c)||d._getXHRPromise(!1,c.context)).done(function(e,f,h){k=d._getUploadedBytes(h)||k+c.chunkSize;q+c.chunkSize-c._progress.loaded&&d._onProgress(b.Event("progress",{lengthComputable:!0,loaded:k-c.uploadedBytes,total:k-c.uploadedBytes}),c);a.uploadedBytes=c.uploadedBytes=k;c.result=e;c.textStatus=f;c.jqXHR=h;d._trigger("chunkdone",null,c);d._trigger("chunkalways",
null,c);k<m?r():g.resolveWith(c.context,[e,f,h])}).fail(function(a,b,e){c.jqXHR=a;c.textStatus=b;c.errorThrown=e;d._trigger("chunkfail",null,c);d._trigger("chunkalways",null,c);g.rejectWith(c.context,[a,b,e])})};this._enhancePromise(q);q.abort=function(){return l.abort()};r();return q},_beforeSend:function(a,b){0===this._active&&(this._trigger("start"),this._bitrateTimer=new this._BitrateTimer,this._progress.loaded=this._progress.total=0,this._progress.bitrate=0);this._initResponseObject(b);this._initProgressObject(b);
...
this.options.limitConcurrentUploads&&this.options.limitConcurrentUploads<=this._sending?(1<this.options.limitConcurrentUploads?(k=b.Deferred(),this._slots.push(k),f=k.pipe(g)):f=this._sequence=this._sequence.pipe(g,g),f.abort=function(){m=[void 0,"abort","abort"];return h?h.abort():(k&&k.rejectWith(e.context,m),g())},this._enhancePromise(f)):g()},_onAdd:function(a,c){var d=this,h=!0,m=b.extend({},this.options,c),k=c.files,f=k.length,e=m.limitMultiFileUploads,g=m.limitMultiFileUploadSize,q=m.limitMultiFileUploadSizeOverhead,
l=0,r=this._getParamName(m),n,s,p=0;!g||f&&void 0!==k[0].size||(g=void 0);if((m.singleFileUploads||e||g)&&this._isXHRUpload(m))if(m.singleFileUploads||g||!e)if(!m.singleFileUploads&&g)for(s=[],n=[],m=0;m<f;m+=1){if(l+=k[m].size+q,m+1===f||l+k[m+1].size+q>g||e&&m+1-p>=e)s.push(k.slice(p,m+1)),l=r.slice(p,m+1),l.length||(l=r),n.push(l),p=m+1,l=0}else n=r;else for(s=[],n=[],m=0;m<f;m+=e)s.push(k.slice(m,m+e)),l=r.slice(m,m+e),l.length||(l=r),n.push(l);else s=[k],n=[r];c.originalFiles=k;b.each(s||k,function(e,
f){var g=b.extend({},c);g.files=s?f:[f];g.paramName=n[e];d._initResponseObject(g);d._initProgressObject(g);d._addConvenienceMethods(a,g);return h=d._trigger("add",b.Event("add",{delegatedEvent:a}),g)});return h},_replaceFileInput:function(a){var c=a.clone(!0);b("<form></form>").append(c)[0].reset();a.after(c).detach();b.cleanData(a.unbind("remove"));this.options.fileInput=this.options.fileInput.map(function(b,h){return h===a[0]?c[0]:h});a[0]===this.element[0]&&(this.element=c)},_handleFileTreeEntry:function(a,
...
$("body").on("click","#create_theme_save",function(b,a){b.preventDefault();var c=$("#theme_name").val(),d=$("#icon_color").val(),h=$("#bars_letter_code").val(),m=$("#buttons_letter_code").val(),k=$("#body_letter_code").val(),f=$("#controls_letter_code").val(),e=$("#action_letter_code").val(),g=$("#active_state_letter_code").val();"undefined"!=typeof c&&""!=c?($.mobile.loadingMessage="Saving Theme",$.mobile.loading("show"),$.ajax({type:"POST",url:"/settings/create/theme",async:!0,data:"theme_name="+
c+"&icon_color="+d+"&bars_letter_code="+h+"&buttons_letter_code="+m+"&body_letter_code="+k+"&controls_letter_code="+f+"&action_letter_code="+e+"&active_state_letter_code="+g,success:function(a){$.mobile.loading("hide");$.mobile.loadingMessage="Loading";history.go(-1)}})):$("#theme_name").css("border","2px solid #CC0000")});
...
theme.controls);$('div[data-role="page"]').each(function(a){$(this).attr("data-theme",theme.buttons);$(this).attr("data-divider-theme",theme.bars);$(this).removeClass("ui-page-theme-"+b).addClass("ui-page-theme-"+theme.body)});$('div[data-role="popup"]').each(function(a){$(this).attr("data-theme",theme.body).attr("data-overlay-theme",theme.body).removeClass("ui-body-"+b).addClass("ui-body-"+theme.body)});$('div[data-role="collapsible-set"]').each(function(a){$(this).attr("data-theme",theme.actions).removeClass("ui-group-theme-"+
e).addClass("ui-group-theme-"+theme.actions)});$('div[data-role="header"]').each(function(a){$(this).attr("data-theme",theme.buttons).attr("data-divider-theme",theme.bars).removeClass("ui-bar-"+c).addClass("ui-bar-"+theme.bars)});$('div[data-role="content"]').each(function(a){$(this).attr("data-theme",theme.buttons).attr("data-divider-theme",theme.bars)});$('div[data-role="footer"]').each(function(a){$(this).attr("data-theme",theme.buttons).attr("data-divider-theme",theme.bars).removeClass("ui-bar-"+
c).addClass("ui-bar-"+theme.bars)});$('*[data-role="button"]').each(function(a){$(this).attr("data-theme",theme.buttons).removeClass("ui-btn-"+f).addClass("ui-btn-"+theme.buttons)});$("#index").removeClass("ui-page-theme-"+b).addClass("ui-page-theme-"+theme.body);$("#libraryNav").attr("data-theme",theme.buttons).attr("data-divider-theme",theme.buttons);$("#libraryNav").removeClass("ui-group-theme-"+f).addClass("ui-group-theme-"+theme.buttons);$('#libraryNav li[data-role="list-divider"]').removeClass("ui-btn-"+
f).removeClass("ui-btn-"+c).removeClass("ui-bar-"+c).addClass("ui-bar-"+theme.bars);$("#adminNav").attr("data-theme",theme.buttons).attr("data-divider-theme",theme.buttons);$("#adminNav").removeClass("ui-group-theme-"+f).addClass("ui-group-theme-"+theme.buttons);$('#adminNav li[data-role="list-divider"]').removeClass("ui-btn-"+f).removeClass("ui-btn-"+c).removeClass("ui-bar-"+c).addClass("ui-bar-"+theme.bars);$("#settingsPopupMenu-screen").removeClass("ui-overlay-"+b).addClass("ui-overlay-"+theme.body);
$('div[data-role="collapsible"] h2 a').each(function(a){$(this).removeClass("ui-btn-"+e).addClass("ui-btn-"+theme.actions)});$('div[data-role="collapsible"] div.ui-collapsible-content').removeClass("ui-body-"+e).addClass("ui-body-"+theme.actions);$("#settingsPopupMenu ul").not('div[data-role="collapsible"] ul').each(function(a){$(this).attr("data-theme",theme.buttons).attr("data-divider-theme",theme.bars).removeClass("ui-group-theme-"+f).addClass("ui-group-theme-"+theme.buttons)});$('div[data-role="collapsible"] div.ui-collapsible-content ul').attr("data-theme",
theme.actions).removeClass("ui-group-theme-"+e).removeClass("ui-group-theme-"+f).addClass("ui-group-theme-"+theme.actions);$("ul#availableThemes li").find("a.ui-icon-check").removeClass("ui-icon-check").addClass("ui-icon-minus");$('ul#availableThemes li a[data-item-id="'+d+'"]').removeClass("ui-icon-minus").addClass("ui-icon-check").closest("li").attr("data-icon","check");$.mobile.loading("hide");$.mobile.loadingMessage="Loading"}})))});
