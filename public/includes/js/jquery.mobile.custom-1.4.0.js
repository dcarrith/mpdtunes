...
$.widget( "mobile.textinput", {
	...
	_classesFromOptions: function() {
		...
		// After adding the linear-gradients back into the swatches, all the text boxes look funky.  
		// So, I decided to stop the addition of the ui-body classes to textinput elements
